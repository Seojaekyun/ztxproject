...
<body>
    <div class="membership-container">
        ...
        <h2 class="section-title">유실물 처리절차</h2>
     		<p><img src="../static/resources/pickup.png"></p>
        <br>
        <br>
        <h2 class="section-title">코레일 주요 유실물 센터 연락처</h2>
        <div id="lost-center" style="padding: 20px 0;">
    <h3 style="color: #003366; font-weight: bold; margin-bottom: 10px;">코레일 주요 유실물 센터 연락처</h3>
