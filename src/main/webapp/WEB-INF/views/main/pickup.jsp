	...
	<div class="membership-container">
		...
		<div>
			<ul>
				...
				<li>역사내 분실 또는 열차 하차 직후 분실사실을 알게 된 경우 : 즉시 역무실로 신고(열차번호, 이용구간,
					승차 호차 및 좌석번호를 알고 계시면 빨리 찾으실 수 있습니다.)</li>
				<li>열차 승차 중 분실 사실을 알게된 경우 : 승무원에게 신고</li>
				<li>분실 사실을 늦게 알게된 경우 : 경찰청 LOST112에서 습득물 확인 후 철도
					고객센터(1588-7788) 또는 주요역 유실물 센터로 문의</li>
			</ul>
			<p>
				<a href="https://www.lost112.go.kr/">www.lost112.go.kr</a>
			</p>
		</div>
		<br> <br>
		...
		<div>
			...
			<p>
				<a href="../static/resources/files/lost_form.hwp" class="button"
					download>대리수령 위임장 서식</a>
			</p>
		</div>
		<br> <br>
		...
		<div>
			<p>
				<img src="../static/resources/pickup.png" alt="유실물 처리절차">
			</p>
		</div>
		<br> <br>
		<h2 class="section-title">꼬레일 주요 유실물 센터 연락처</h2>
		<div id="lost-center">
			<input type="text" id="searchStation" placeholder="역명을 입력하세요"
				style="width: 300px; padding: 8px; margin-bottom: 15px; border: 1px solid #ccc;">
			<ul id="stationList" style="list-style: none; padding: 0;">
				<li data-station="서울역" style="padding: 5px 0; cursor: pointer;">-
					서울역</li>
				<li data-station="용산역" style="padding: 5px 0; cursor: pointer;">-
					용산역</li>
				<li data-station="수원역" style="padding: 5px 0; cursor: pointer;">-
					수원역</li>
				<li data-station="부산역" style="padding: 5px 0; cursor: pointer;">-
					부산역</li>
				<li data-station="대전역" style="padding: 5px 0; cursor: pointer;">-
					대전역</li>
				<li data-station="광주송정역" style="padding: 5px 0; cursor: pointer;">-
					광주송정역</li>
			</ul>
			<div id="stationDetail"
				style="display: none; margin-top: 20px; padding: 15px; border: 1px solid #ccc; background: #f9f9f9;">
