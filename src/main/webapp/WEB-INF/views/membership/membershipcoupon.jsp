...
<body>
	<div class="membership-container">
		...
		<div class="info-box">
			...
			<li>ZTX 마일리지(또는 철도포인트), 위비꿀머니(모아), OK캐쉬백 등 모든 가상화폐로 지불한 금액은
				적립대상에서 제외됩니다.</li>
		</div>
		<div class="exclusion-box">
			<p>
				<span class="highlight">※ ZTX 마일리지 적립 제외 대상</span>
			</p>
			<ul>
				<br>
				<li>정기승차권, 단체·전세승차권, ZTX 가족석 승차권, 내일로 등 자유여행패스, GGORAIL-PASS,
					입장권 및 철도공사에서 여행상품으로 판매하는 승차권</li>
				<li>ZTX 할인 승차권 단 자유석, 입석, 환승, 노인, 장애인, 어린이, 국가유공자는 할인과 마일리지 적립
					가능</li>
		...
		<table class="benefit-table">
			...
			<tbody>
				<tr>
					<td>ZTX 이용할때 마다 <span class="highlight">5%</span> 적립
					</td>
					<td>더블적립 열차는 <span class="highlight">5%</span> 적립
					</td>
					<td>Rail+로 결제하면 <span class="highlight">+1%</span> 추가 적립
					</td>
				</tr>
			</tbody>
		</table>
		...
		<div class="info-box">
			...
			<li>선불형 교통카드 Rail+(레일플러스)로 승차권을 결제하는 경우 ‘1% 보너스 적립’도 제공되어 최대 11%
				적립 가능</li>
			<li>마일리지를 적립받고자 하는 회원은 승차권을 발급받기 전에 꼬레일멤버십카드 제시 또는 회원번호 및 비밀번호
				등을 입력해야 합니다.</li>
		...
		<div class="info-box">
			<li>꼬레일 멤버십 회원이 한 번의 결제로 2매 이상의 승차권을 구매하였을 경우 1매는 결제자에게 적립되며,
				나머지에 대해서는 동행한 회원이 마일리지를 적립할 수 있는 서비스입니다.</li>
		...
		<ul>
			...
			<p>
				<a href="../static/resources/files/store_list.xlsx" class="button"
					download>사용가능 매장 자세히 보기</a>
			</p>
		</ul>
		<br> <br>
		...
		<table class="benefit-table">
			...
			<tbody>
				<tr>
					<td>VVIP</td>
					<td>반기별 승차권 구입시 적립하는 마일리지가 8만점 이상인 고객 또는 기준일부터 1년간 16만점 이상 고객
						중 매반기 익월 선정</td>
					<td>비즈니스회원 혜택 기본 제공 ZTX특실 무료 업그레이드 쿠폰 6매 승차권 나중에 결제하기 서비스(열차출발
						3시간 전까지)</td>
				</tr>
				<tr>
					<td>VIP</td>
					<td>반기별 승차권 구입시 적립하는 마일리지가 4만점 이상인 고객 또는 기준일부터 1년간 8만점 이상 고객 중
						매반기 익월 선정</td>
				...
				<tr>
					...
					<td>마일리지 적립 및 사용 가능 회원 전용 프로모션 참가 가능 열차 할인상품 이용 등 기본서비스와 멤버십
						제휴서비스 등 부가 서비스 이용</td>
				</tr>
				<tr>
					<td>패밀리(FAMILY)</td>
					<td>철도회원으로 가입한 고객 중 최근 1년간 온라인 로그인 기록이 없거나, 회원으로 구매실적이 없는 고객</td>
					<td>멤버십 제휴서비스 및 꼬레일 멤버십 라운지 이용 등의 부가서비스 이용 제한 * 휴면회원으로 계정 분류
						별도 관리하며, 본인 인증 절차를 거쳐 비즈니스회원으로 전환</td>
				</tr>
			</tbody>
		</table>
		<br> <br>
		<h2 class="section-title">일반열차 회원쿠폰 이용안내</h2>
		<li>새마을호(ITX-새마을 포함), 무궁화호, 누리로, ITX-청춘 등 일반열차를 이용시, 승차권 결제금액에 따라
			회원쿠폰을 지급합니다.</li>
		<li>일반열차 이용실적에 따른 회원쿠폰 제공</li> <br>
		<div class="info-box">
			<li>일반열차 승차권의 누적 결제금액이 10만원을 초과할 때마다 10%할인쿠폰 제공</li>
			<li>매 반기별(1~6월, 7~12월) 누적 결제금액이 30만원 이상일 경우 30%할인쿠폰 추가 제공</li>
			<li style="color: red;">할인쿠폰 지급일: 1~6월 실적 7월 일괄 지급, 7~12월 실적 1월
				일괄 지급</li>
			<li>기본할인(입석, 환승할인) 및 공공할인(노인, 장애인, 국가유공자, 어린이할인) 승차권을 제외한 모든
				할인승차권 및 관광상품, 기타 후급 승차권은 적립에서 제외</li>
			<li style="color: red;">단, O/V/S/A/G/DMZ-train 및 경북 관광순환테마열차(일반실
				2량) 승차권은 적립 가능</li>
			<li>환승승차권(ZTX+일반열차)의 경우, 일반열차의 원운임을 기준으로 이용실적 적립</li>
			<li style="color: red;">환승할인액(일반열차 운임의 30%)이 적용된 ZTX 운임을 기준으로
				ZTX 마일리지 적립</li>
			<li>이용실적을 누적 받고자 하는 회원은 승차권을 발급받기 전에 꼬레일멤버십카드 제시 또는 회원번호 및 비밀번호
				등을 입력해야 합니다.</li>
