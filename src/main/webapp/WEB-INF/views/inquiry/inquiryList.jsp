...
<body>
	...
	<div class="cscmc">
		<div class="cscmenu">
			<a href="../gongji/list">공지 사항</a> <a href="../inquiry/inquiryList">Q＆A</a>
			<a href="#">이벤트</a> <a href="../review/list">여행 후기</a>
		</div>
	</div>
	<section>
		<div id="tablebox">
			<table>
				...
				<tbody>
					<c:forEach var="inquiry" items="${inquiries}">
						<tr>
							<td>${inquiry.id}</td>
							<td class="status-${inquiry.status}"><c:choose>
							...
							<td style="text-align: left"><a
								href="/inquiry/readnum?id=${inquiry.id}">${inquiry.title}</a></td>
