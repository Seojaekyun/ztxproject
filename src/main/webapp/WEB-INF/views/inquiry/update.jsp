		...
		<form action="/inquiry/updateOk" method="POST">
			...
			<div class="mb-3">
				<label class="form-label">연락처</label> <input type="text"
					class="form-control" name="phone" value="${inquiry.phone}" required>
			</div>
			...
			<div class="mb-3">
				<label class="form-label">문의 유형</label> <select class="form-select"
					...
					<option value="2" ${inquiry.category == 2 ? 'selected' : ''}>단순
						문의</option>
					<option value="3" ${inquiry.category == 3 ? 'selected' : ''}>친절
						제보</option>
					<option value="4" ${inquiry.category == 4 ? 'selected' : ''}>서식
						VOC</option>
					<option value="5" ${inquiry.category == 5 ? 'selected' : ''}>시민
						재해 예방</option>
				</select>
			</div>
			...
			<div class="mb-3">
				<label class="form-label">제목</label> <input type="text"
					class="form-control" name="title" value="${inquiry.title}" required>
			</div>
